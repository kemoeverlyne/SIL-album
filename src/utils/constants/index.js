...
export const generateInvitationHTMLString = (data) => {
  return `<!DOCTYPE html>
        ...
        <body>
            ...
            <footer>
                <p style="font-size:16px;">photo-album is an app created by <a href="https://www.github.com/bkfan1" style="color: #3182ce; font-weight: bold;">Jackson Paredes Ferranti (@bkfan1)</a></p>
            </footer>
